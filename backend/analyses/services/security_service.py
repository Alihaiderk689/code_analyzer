...
from .types import BaseSecurityScanner, SecurityFinding
...
class SecurityAnalysisService:
    ...
    def analyze(self, source_code: str, language: str, filename: str = 'submission.py', settings_source: str = '') -> dict:
        findings = self._run_scanners(source_code, filename, language, settings_source)
        findings = self._deduplicate(findings)
        findings = self.ai_service.enrich(findings, source_code)
        return self.report_generator.build_report(findings)

    def _run_scanners(self, source_code: str, filename: str, language: str, settings_source: str = '') -> list[SecurityFinding]:
        ...
        for scanner in self.scanners:
            ...
            try:
                ...
                # and a partial report beats a 500.
